...
\end{tabular}
\end{center}
A senha "flamengo" foi testada na mesma máquina que utilizamos para executar os testes CUDA. Ele foi o único que teve 
...
Devido ao limite computacional , optamos por não utilizar a analise de frequencia ja que iria aumentaria substancialmente o tempo de execução de um único teste. e o nosso objetivo é comparar a execução sequencial com a concorrente demonstrando o ganho
\section{Conclusões}
